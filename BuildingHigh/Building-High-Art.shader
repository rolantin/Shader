...
////// Lighting:
                ...
                float4 finalColor = FINAL_SHADOW_COLOR_SINGLE(((_EmssionMap_var.rgb*_EmssionColor.rgb)+PBRSpecular(normalDirection, 
                                    viewDirection,_Metallic_var.rgb,_Metallic_var.a,_Metallic_var.r,(((_Albedo_var.rgb*_Color.rgb)/_ToLinrar)*node_5382),(node_8468*GetEnvirmentColor(normalDirection)),((texCUBE(_SpecIBL,viewReflectDirection).rgb*_SpecIBLPower*_Metallic_var.rgb)*2.0))), i, normalDirection);
