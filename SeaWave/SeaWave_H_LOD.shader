	...
	SubShader
	{
		...
		{   
			...
			float4 frag (VertexOutput i):COLOR{
			   ...
			   half deltaDepth = 1-tex2D(_DepthMark, i.uv1).r *_DepthPower;
			   float3 gradient = ColorSpace (lerp(_TopColor,_DeepColor,deltaDepth))*_GTexcolor;
...
////////Albedo				
			    ...
			    float3 albedo = waterColor.xyz*gradient;
